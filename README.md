...
[![Version](https://img.shields.io/badge/version-0.0.14-orange)](./CHANGELOG.md)
...
> [!WARNING]
> **This project is in early development (v0.0.14).** The build system is fully functional, but the application itself is not yet complete. Use for development and learning purposes only.
